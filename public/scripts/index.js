...
// Add the event listener for showing or hiding the password requirements
// under the input password field
...
function switchForm(event) {
    ...
    if (event.target.id === loginButton.id) {
        ...
        state = 'register'
        // Add the event listener for password requirements, password validator and for
        // comparing the confirmation password and the password
        confirmationPassword.addEventListener(
            'keyup',
            checkIfPasswordAreTheSame
        )
        // Adding the event listener back
        password.addEventListener('keyup', showHidePasswordRequirements)
        password.addEventListener('keyup', passwordValidator)
...
export { form, submit, passwordError, loginButton, state }
